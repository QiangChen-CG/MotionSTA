...
import sys
#sys.path.append('/home/laishidanchun/Code/MotionDiffuse-main/text2motion')
#sys.path.append('../')
BASE_DIR= os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
sys.path.append(BASE_DIR)

from utils import paramUtil as paramUtil
from options.train_options import TrainCompOptions
from utils.plot_script import *

#from models import MotionTransformer
from models.nn import MotionTransformer
...
if __name__ == '__main__':
    envpath = '/home/lsdc/anaconda3/lib/python3.10/site-packages/cv2/qt/plugins/platforms'
